...
describe "A hash in the array returned by Sequel::Schema::DbColumnSchemaParser#parse" do
  before :each do
    @parser = Sequel::Schema::DbColumnSchemaParser.new
